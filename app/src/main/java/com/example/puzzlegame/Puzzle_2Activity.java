...
public class Puzzle_2Activity extends AppCompatActivity {
    ...
    private static void display(Context context) {
        ...
        for (int i = 0; i < tileList.length; i++) {
            ...
            if (tileList[i].equals("0"))
                button.setBackgroundResource(R.drawable.lord_1);
            else if (tileList[i].equals("1"))
                button.setBackgroundResource(R.drawable.lord_2);
            else if (tileList[i].equals("2"))
                button.setBackgroundResource(R.drawable.lord_3);
            else if (tileList[i].equals("3"))
                button.setBackgroundResource(R.drawable.lord_4);
            else if (tileList[i].equals("4"))
                button.setBackgroundResource(R.drawable.lord_5);
            else if (tileList[i].equals("5"))
                button.setBackgroundResource(R.drawable.lord_6);
            else if (tileList[i].equals("6"))
                button.setBackgroundResource(R.drawable.lord_7);
            else if (tileList[i].equals("7"))
                button.setBackgroundResource(R.drawable.lord_8);
            else if (tileList[i].equals("8"))
                button.setBackgroundResource(R.drawable.lord_9);

            buttons.add(button);
        }

        mGridView.setAdapter(new CustomAdapter1(buttons, mColumnWidth, mColumnHeight));
    }
